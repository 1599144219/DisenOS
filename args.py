...
def read_options():
    ...
    parser.add_argument("--max_neighbor", default=25, type=int)
    ...
    parser.add_argument("--seed", default='19980110', type=int)

    parser.add_argument("--k_factors", default=3, type=int)  
